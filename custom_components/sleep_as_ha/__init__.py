...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry):
    ...
    hass.data[DOMAIN][config_entry.entry_id] = SleepAsHAInstance(
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if unload_ok:
        instance: SleepAsHAInstance = hass.data[DOMAIN].pop(entry.entry_id)
...
#             _hass.components.mqtt.async_subscribe()
