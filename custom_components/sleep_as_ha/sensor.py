...
async def async_setup_entry(
    ...
    async def add_configured_entities():
        ...
        sensors: list[SleepTrackerSensor] = []
        for entity in entities:
            ...
            (sensor, _) = instance.get_sleep_sensor(device_name)
...
class SleepTrackerSensor(SensorEntity, RestoreEntity):
    ...
    def process_message(self, msg, triggers=None):
